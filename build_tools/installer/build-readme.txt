Building the PowerChain installer
...
Edit mac-release-package.sh and replace "Developer ID Application: Stichting PWRC (YU63QW5EFW)" with your developer signature (you can also remove -Bmac.signing-key-developer-id-app="Developer ID Application: Stichting PWRC (YU63QW5EFW)" to generate an unsigned package)
...
Copy the content of Java JRE folder (C:\Program Files\Java\jre<version>) into the jre folder under your pwrc-private git repository preserving the folder structure
...
Test the installer using Java: java -jar pwrc-client-<version>.jar
Test the windows executable: pwrc-client-<version>.exe
