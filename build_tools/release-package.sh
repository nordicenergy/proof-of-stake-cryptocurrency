...
then
echo obfuscate
/opt/proguard/bin/proguard.sh @pwrc.pro
...
cd -
zip -q -X -r ${PACKAGE}.zip pwrc -x \*/.idea/\* \*/.gitignore \*/.git/\* \*/\*.log \*.iml pwrc/conf/pwrc.properties pwrc/conf/logging.properties pwrc/conf/localstorage/\*
rm -rf pwrc
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/pwrc/downloads/${PACKAGE}.zip" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/pwrc/downloads/${PACKAGE}.sh" >> ${CHANGELOG}
echo >> ${CHANGELOG}
echo "sha256:" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/pwrc/downloads/${PACKAGE}.exe" >> ${CHANGELOG}
echo >> ${CHANGELOG}
#echo "sha256:" >> ${CHANGELOG}
#sha256sum ${PACKAGE}.exe >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/pwrc/downloads/pwrc-installer-${VERSION}.dmg" >> ${CHANGELOG}
echo >> ${CHANGELOG}

echo "The exe, dmg, and sh packages must have a digital signature by \"Stichting PWRC\"." >> ${CHANGELOG}
