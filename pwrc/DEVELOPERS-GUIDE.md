...
### Database ###
  ...
  - main database: `pwrc_db/`
  - test database: `pwrc_test_db/`
  ...
  - use the pwrc.db framework when accessing the database from your code
...
- https://crowdin.com/project/pwrc-ui-translation
...
The PWRC wallet UI run as a mobile app.
