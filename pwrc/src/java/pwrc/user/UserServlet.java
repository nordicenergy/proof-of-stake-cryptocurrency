...
import static pwrc.user.JSONResponses.DENY_ACCESS;
import static pwrc.user.JSONResponses.INCORRECT_REQUEST;
import static pwrc.user.JSONResponses.POST_REQUIRED;
...
public final class UserServlet extends HttpServlet  {
    ...
    private static final boolean enforcePost = Pwrc.getBooleanProperty("pwrc.uiServerEnforcePOST");
