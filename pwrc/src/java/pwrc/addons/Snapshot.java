...
public class Snapshot implements AddOn {
    ...
    private static final int snapshotHeight = Pwrc.getIntProperty("pwrc.snapshotHeight", Integer.MAX_VALUE);
    private static final boolean snapshotForTestnet = Pwrc.getBooleanProperty("pwrc.snapshotForTestnet", true);

    private static final Set<String> scammerAccounts = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
            Long.toUnsignedString(Convert.parseAccountId("PWRC-TN8U-RBVE-GBJ3-7DEBN")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-V79Z-RQ5X-XXJR-H8P87")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-BH28-PKY6-LES8-29DBN")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-ZKV3-J2WN-T6VM-B28DA")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-ZPRA-ZDUQ-SYEL-7AAJM")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-UMZH-XLBB-BGSY-7WESP")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-5CFL-QTTH-D6K2-AC4TF")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-B2KJ-DAAF-884G-GENQ8")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-L8JG-U967-NUNS-BA4RK")), // scammer
            Long.toUnsignedString(Convert.parseAccountId("PWRC-LSMJ-YCH7-QESX-AH42N")), // compromised
            Long.toUnsignedString(Convert.parseAccountId("PWRC-E8JD-FHKJ-CQ9H-5KGMQ"))  // compromised
    )));

    private static final String wrongBountyAccount = Long.toUnsignedString(Convert.parseAccountId("PWRC-XTJE-PLDX-EZ6E-6FQX6"));

    private static final String AEUR_ACCOUNT = "PWRC-NJ92-R5GB-HQB4-6NW7T";

    @Override
    public void init() {

        Pwrc.getBlockchainProcessor().addListener(new Listener<Block>() {
            ...
            private boolean invalidCurrency(String code, String normalizedName) {
                ...
                if (code.contains("PWRC") || code.contains("NEXT") || "pwrc".equals(normalizedName) || "next".equals(normalizedName)) {
                    return true;
                }
