...
public final class AddOns {
    ...
    static {
        ...
        Pwrc.getStringListProperty("pwrc.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Pwrc.getBooleanProperty("pwrc.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Pwrc.isDesktopApplicationEnabled() ? "nxtdesktop.policy" : "pwrc.policy");
