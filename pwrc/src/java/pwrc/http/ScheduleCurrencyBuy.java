...
import pwrc.TransactionScheduler;
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws NxtException {
        ...
        try {
            ...
            if (transactionBytes == null && transactionJSON == null) {
                ...
                transaction = Pwrc.newTransactionBuilder((JSONObject) response.get("transactionJSON")).build();
            } else {
            ...
            try {
                ...
                try (DbIterator<? extends Transaction> unconfirmedTransactions = Pwrc.getTransactionProcessor().getAllUnconfirmedTransactions()) {
