...
/**
 * Issue a currency on the PWRC blockchain
 * <p>
 * A currency is the basic block of the PWRC Monetary System it can be exchanged with PWRC, transferred between accounts,
 ...
 * For {@link pwrc.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum PWRC value per unit to allow the currency to become active
 * For {@link pwrc.CurrencyType#RESERVABLE} currency
 ...
 * For {@link pwrc.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link pwrc.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link pwrc.crypto.HashFunction algorithm} used for minting.
 * For {@link pwrc.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link pwrc.CurrencyType#EXCHANGEABLE} nor {@link pwrc.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link pwrc.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link pwrc.CurrencyType#RESERVABLE} becomes active, in case it is {@link pwrc.CurrencyType#CLAIMABLE} the PWRC used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link pwrc.CurrencyType#RESERVABLE} becomes active, in case it is non {@link pwrc.CurrencyType#CLAIMABLE} the PWRC used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link pwrc.CurrencyType#MINTABLE} currency, the number of units per {@link pwrc.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link pwrc.http.CurrencyMint}<br>
 * </ul>
 *
 * @see pwrc.CurrencyType
 * @see pwrc.crypto.HashFunction
 */
