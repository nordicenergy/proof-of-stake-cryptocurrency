...
import static pwrc.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static pwrc.http.JSONResponses.UNKNOWN_ACCOUNT;
import static pwrc.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer PWRC, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * PWRC amounts are specified with 8 decimal places.  Asset and Currency decimal places
