...
import static pwrc.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static pwrc.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static pwrc.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static pwrc.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws NxtException {
        ...
        try {
            ...
            if (deliveryDeadline <= Pwrc.getEpochTime()) {
