...
import pwrc.TransactionProcessor;
 ...
 * has not been received within pwrc.apiEventTimeout seconds.
 *
 * The maximum number of event users is specified by pwrc.apiMaxEventUsers.
 */
class EventListener implements Runnable, AsyncListener, TransactionalDb.TransactionCallback {

    /** Maximum event users */
    static final int maxEventUsers = Pwrc.getIntProperty("pwrc.apiMaxEventUsers");

    /** Event registration timeout (seconds) */
    static final int eventTimeout = Math.max(Pwrc.getIntProperty("pwrc.apiEventTimeout"), 15);

    /** Blockchain processor */
    static final BlockchainProcessor blockchainProcessor = Pwrc.getBlockchainProcessor();

    /** Transaction processor */
    static final TransactionProcessor transactionProcessor = Pwrc.getTransactionProcessor();
     ...
     *
     * Pwrc event listeners will be added for the specified events
     *
     * @param   eventRegistrations      List of Pwrc event registrations
     ...
     *
     * @param   eventRegistrations      Pwrc event registrations
     * @throws  EventListenerException  Invalid Pwrc event
     */
    ...
    private class NxtEventListener {
        ...
        /**
         * Create the Pwrc event listener
         *
        ...
        /**
         * Add the Pwrc listener for this event
         */
        ...
        /**
         * Remove the Pwrc listener for this event
         */
        ...
        /**
         * Return the hash code for this Pwrc event listener
         *
         * @return                  Hash code
         */
        @Override
        ...
        /**
         * Check if two Pwrc events listeners are equal
         *
    ...
    static class EventRegistration {
         ...
         *
         * @param   event           Pwrc listener event
        ...
        /**
         * Return the Pwrc listener event
         *
         * @return                  Pwrc listener event
         */
        public Enum<? extends Enum> getEvent() {
            return event;
        }
