...
/**
 * Increase the value of currency units by paying PWRC
 * <p>
 * Parameters
 * <ul>
 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link pwrc.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link pwrc.http.GetCurrencyFounders} API.
 */
