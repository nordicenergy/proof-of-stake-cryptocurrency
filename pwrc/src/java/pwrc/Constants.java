...
public final class Constants {
    ...
    public static final boolean isTestnet = Pwrc.getBooleanProperty("pwrc.isTestnet");
    public static final boolean isOffline = Pwrc.getBooleanProperty("pwrc.isOffline");
    public static final boolean isLightClient = Pwrc.getBooleanProperty("pwrc.isLightClient");
    public static final String customLoginWarning = Pwrc.getStringProperty("pwrc.customLoginWarning", null, false, "UTF-8");
    ...
    public static final int MAX_ROLLBACK = Math.max(Pwrc.getIntProperty("pwrc.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Pwrc.getIntProperty("pwrc.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Pwrc.getIntProperty("pwrc.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_NXT;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Pwrc.getIntProperty("pwrc.forgingDelay");
    public static final int FORGING_SPEEDUP = Pwrc.getIntProperty("pwrc.forgingSpeedup");
    public static final int BATCH_COMMIT_SIZE = Pwrc.getIntProperty("pwrc.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = Pwrc.getIntProperty("pwrc.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Pwrc.getBooleanProperty("pwrc.includeExpiredPrunable");
    ...
    public static final boolean correctInvalidFees = Pwrc.getBooleanProperty("pwrc.correctInvalidFees");
