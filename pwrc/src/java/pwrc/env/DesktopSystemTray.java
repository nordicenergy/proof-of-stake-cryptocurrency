...
public class DesktopSystemTray {
    ...
    void createAndShowGUI() {
        ...
        imageIcon = new ImageIcon("html/www/img/pwrc-icon-32x32.png", "tray icon");
        ...
        if (!Pwrc.isDesktopApplicationEnabled()) {
    ...
    private void displayStatus() {
        ...
        addDataRow(statusPanel, "Application", Pwrc.APPLICATION);
        addDataRow(statusPanel, "Version", Pwrc.VERSION);
        ...
        addDataRow(statusPanel, "User folder", String.valueOf(Paths.get(Pwrc.getUserHomeDir()).toAbsolutePath()));
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Seconds passed", String.valueOf(Pwrc.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", Pwrc.getProcessId());
        addEmptyRow(statusPanel);
        ...
        if (statusDialog == null || !statusDialog.isVisible()) {
            ...
            statusDialog = pane.createDialog(wrapper, "PWRC Server Status");
