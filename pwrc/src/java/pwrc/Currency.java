...
public final class Currency {
    ...
    static {
        Pwrc.getBlockchainProcessor().addListener(new CrowdFundingListener(), BlockchainProcessor.Event.AFTER_BLOCK_APPLY);
    }
    ...
    private Currency(Transaction transaction, Attachment.MonetarySystemCurrencyIssuance attachment) {
        ...
        this.creationHeight = Pwrc.getBlockchain().getHeight();
