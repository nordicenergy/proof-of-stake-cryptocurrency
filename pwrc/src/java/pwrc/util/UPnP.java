...
public class UPnP {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Pwrc.getIntProperty("pwrc.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Pwrc.getIntProperty("pwrc.upnpDiscoverTimeout", discover.getTimeout()));
