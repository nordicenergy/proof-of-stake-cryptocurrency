...
/**
 * Java LogManager extension for use with Pwrc
 */
public class NxtLogManager extends LogManager {
     ...
     * done terminating the Pwrc processes.
     */
     ...
     * This allows us to continue to use logging facilities during Pwrc shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Pwrc shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void nxtShutdown() {
        super.reset();
