...
/**
 * Handle logging for the Pwrc node server
 */
public final class Logger {
     ...
     * The pwrc/conf/logging-default.properties and pwrc/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "pwrc.util.NxtLogManager");
        if (!(LogManager.getLogManager() instanceof NxtLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("pwrc.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                Pwrc.loadProperties(loggingProperties, "logging-default.properties", true);
                Pwrc.loadProperties(loggingProperties, "logging.properties", false);
                Pwrc.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(pwrc.Pwrc.class);
        enableStackTraces = Pwrc.getBooleanProperty("pwrc.enableStackTraces");
        enableLogTraceback = Pwrc.getBooleanProperty("pwrc.enableLogTraceback");
