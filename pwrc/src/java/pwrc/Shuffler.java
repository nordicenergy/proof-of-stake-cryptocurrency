...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Pwrc.getIntProperty("pwrc.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Pwrc.getBlockchain().getHeight() + 720;
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Pwrc.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(Pwrc.getBlockchain().getLastBlockTimestamp());
