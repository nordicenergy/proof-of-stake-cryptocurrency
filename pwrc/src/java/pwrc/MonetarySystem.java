...
public abstract class MonetarySystem extends TransactionType {
    ...
    public static final TransactionType CURRENCY_ISSUANCE = new MonetarySystem() {
        ...
        Fee getBaselineFee(Transaction transaction) {
            ...
            if (Pwrc.getBlockchain().getHeight() < Constants.IGNIS_BLOCK && (Currency.getCurrencyByCode(attachment.getCode()) != null || Currency.getCurrencyByCode(attachment.getName()) != null
    ...
    public static final TransactionType RESERVE_INCREASE = new MonetarySystem() {
        ...
        void validateAttachment(Transaction transaction) throws NxtException.ValidationException {
            ...
            if (attachment.getAmountPerUnitNQT() <= 0) {
                throw new NxtException.NotValidException("Reserve increase PWRC amount must be positive: " + attachment.getAmountPerUnitNQT());
            }
        ...
        void undoAttachmentUnconfirmed(Transaction transaction, Account senderAccount) {
            ...
            if (currency != null) {
                ...
                Transaction currencyIssuance = Pwrc.getBlockchain().getTransaction(attachment.getCurrencyId());
