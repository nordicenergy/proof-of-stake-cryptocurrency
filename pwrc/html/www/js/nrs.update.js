...
var NRS = (function(NRS, $) {
	var DOWNLOAD_REPOSITORY_URL = "https://bitbucket.org/Jelurida/pwrc/downloads/";
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "pwrc-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "pwrc-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "pwrc-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "pwrc-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "pwrc-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "pwrc-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "pwrc-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "pwrc-client-", ext: "sh"}
	];
