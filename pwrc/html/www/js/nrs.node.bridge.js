const options = {
    url: "http://localhost:6876", // URL of PWRC remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the PWRC client wasn't designed with modularity in mind therefore we need
            ...
            // Now load some PWRC specific libraries into the global scope
            ...
            // however the PWRC client relies on a global browser scope which defines the NRS object
