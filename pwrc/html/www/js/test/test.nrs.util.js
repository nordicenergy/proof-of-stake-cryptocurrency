...
QUnit.test("formatAmount", function (assert) {
    ...
    assert.equal(NRS.formatAmount("123456700000000", true, true), Number("1234567").toLocaleString(), "pwrc.rounding");
...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831 }, "entity"), "<a href='#' data-user='PWRC-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'>/</a>", "numeric");
    assert.equal(NRS.getAccountLink({ entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>PWRC-XK4R-7VJU-6EQG-7R335</a>", "RS");
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831, entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>PWRC-XK4R-7VJU-6EQG-7R335</a>", "numeric.and.RS");
    NRS.contacts = { "PWRC-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    NRS.accountRS = "PWRC-XK4R-7VJU-6EQG-7R335";
    assert.equal(NRS.getAccountLink({ entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>You</a>", "you");
    assert.equal(NRS.getAccountLink({ entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity", "PWRC-XK4R-7VJU-6EQG-7R335", "account"), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>Account</a>", "force.account.name");
    assert.equal(NRS.getAccountLink({ entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, true), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>PWRC-XK4R-7VJU-6EQG-7R335</a>", "maintain.rs.format");
    assert.equal(NRS.getAccountLink({ entityRS: "PWRC-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, undefined, "btn btn-xs"), "<a href='#' data-user='PWRC-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info btn btn-xs'>You</a>", "add.class");
    NRS.contacts = null;
    NRS.accountRS = null;
    NRS.constants.GENESIS = 1739068987193023818;
    NRS.constants.GENESIS_RS = "PWRC-MR8N-2YLS-3MEQ-3CMAJ";
    assert.equal(NRS.getAccountLink({ entityRS: NRS.constants.GENESIS_RS }, "entity"), "<a href='#' data-user='PWRC-MR8N-2YLS-3MEQ-3CMAJ' class='show_account_modal_action user-info'>Genesis</a>", "genesis");
});
